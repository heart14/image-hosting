...
public class SysExceptionHandler {
    ...
    public SysResponse httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
    ...
    public SysResponse httpMessageNotReadableException(HttpMessageNotReadableException e) {
